...
import {updateEmployeeSalary,fetchAllEmployee, giveBonuses, addCoupon, applyCoupon} from "../../Backend/controller/managerController.js";
import {placeOrder,viewOrderSummary,dailySaleReport, monthYearSale} from "../../Backend/controller/cashierController.js";
...
route.get("/api/cashierController/monthYearSale",monthYearSale);
